...
public interface IBaseRepository<T>
{
    ...
    /// If the Item has a <see cref="ComplexCollectionAttribute"/>,
    /// the <see cref="UpdateComplex"/> method is used to update the collections
    /// and remove orphaned items from the database.
    /// </summary>
    ...
    /// Updates an item in the database.
    /// If the Item has a <see cref="ComplexCollectionAttribute"/>,
    /// the <see cref="UpdateComplexAsync"/> method is used to update the collections
    /// and remove orphaned items from the database.
    /// </summary>
    /// <param name="item">Item to update.</param>
    /// <returns>An <see cref="IDbResult{T}"/> based on the success status.</returns>
    ...
    /// <summary>
    /// Updates an item with sub-collections in the database.
    /// Calls an abstract method to remove items from the db item
    /// which are no longer on the incoming item.
    /// </summary>
    /// <param name="item">Item to update.</param>
    /// <returns>An <see cref="IDbResult{T}"/> based on the success status.</returns>
    ...
    /// <param name="item">Item to update.</param>
    /// <returns>An <see cref="IDbResult{T}"/> based on the success status.</returns>
    public Task<IDbResult<T>> UpdateComplexAsync(T item);
